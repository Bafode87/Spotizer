<template>
    <BackButtonComponent/>
    <div class="container__songDetail">
        <div v-if="song.album" class="song__album">
            ALBUM <p class="song__album__title">{{ song.album.title }}</p>
        </div>

        <div>
            <div class="song__videoPlayer">
                <iframe :src="song.youtube" frameborder="0"
            ...
            <div class="song__info">
                ...
                <div class="song__titleAndArtist">
                    <p class="song__title">{{ song.title }}</p>
                    <router-link :to='`${pathOfArtist}${song.artist.id}`'>
